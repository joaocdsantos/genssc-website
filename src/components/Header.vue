<template>
	<header class="header">
		<div class="logo">
			<img
				src="../assets/logos/genssc_logo.png"
				alt="Logotipo Gens Sport Clube"
				loading="lazy" />
			<img
				src="../assets/logos/logo100anos_LR.png"
				alt="Logotipo Centenário Gens Sport Clube"
				loading="lazy" />
		</div>
			...
			<ul>
				<li v-for="item in menuItems" :key="item.name">
					...
					<a
						...
						@click="navigateToAnchor(item.link)">
						<component :is="item.icon" class="menu-item-icon" />
						<span>{{ item.name }}</span>
					</a>
